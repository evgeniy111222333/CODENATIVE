...
The current repository implements three layers of the HTM Code-Native design:
...
9. A fused hidden state produces blended LM + semantic + recent + episodic logits.
